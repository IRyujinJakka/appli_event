...
"resource": {
  ...
  "rules":[
    ...
    [["if",43,110,111],["unless",77],["add",73]],
    [["if",112],["add",75,141,142]],
    [["if",0,114],["add",147]],
    [["if",115,116,117],["add",148,150]],
    [["if",0,118,119],["unless",115],["add",149]],
    [["if",0,120],["add",153]],
    [["if",0],["unless",121],["add",154]],
    [["if",8,122,123],["add",155]],
    [["if",3,125,127],["unless",124,126],["add",156]],
    [["if",3,125,129,130,131],["unless",128],["add",158]],
    [["if",5,6],["block",3]],
    [["if",6,113],["block",144,145,146,151,155]]]
},
...
return null},Cf=!1;if(K.querySelectorAll)try{var Df=K.querySelectorAll(":root");Df&&1==Df.length&&Df[0]==K.documentElement&&(Cf=!0)}catch(a){}var zf=Cf;var Gd={},Rf=null,Sf=Math.random();Gd.B="GTM-W7MBMN";Gd.Rb="640";Gd.Sd="";var Tf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Uf="www.googletagmanager.com/gtm.js";
var Vf=Uf,Wf=null,Xf=null,Yf=null,Zf="//www.googletagmanager.com/a?id="+Gd.B+"&cv=363",$f={},ag={},bg=function(){var a=Rf.sequence||0;Rf.sequence=a+1;return a};
...
Math.max(e.right-d,0))/g,1))*(1-Math.min((Math.max(0-e.top,0)+Math.max(e.bottom-c,0))/f,1)):0},Tn=function(a){if(K.hidden)return!0;var b=a.getBoundingClientRect();if(b.top==b.bottom||b.left==b.right||!E.getComputedStyle)return!0;var c=E.getComputedStyle(a,null);if("hidden"===c.visibility)return!0;for(var d=a,e=c;d;){if("none"===e.display)return!0;var f=e.opacity,g=e.filter;if(g){var k=g.indexOf("opacity(");0<=k&&(g=g.substring(k+8,g.indexOf(")",k)),"%"==g.charAt(g.length-1)&&(g=g.substring(0,g.length-
1)),f=Math.min(g,f))}if(void 0!==f&&0>=f)return!0;(d=d.parentElement)&&(e=E.getComputedStyle(d,null))}return!1};var Un=[],Vn=!(!E.IntersectionObserver||!E.IntersectionObserverEntry),Wn=function(a,b,c){for(var d=new E.IntersectionObserver(a,{threshold:c}),e=0;e<b.length;e++)d.observe(b[e]);for(var f=0;f<Un.length;f++)if(!Un[f])return Un[f]=d,f;return Un.push(d)-1},Xn=function(a,b,c){function d(k,l){var m={top:0,bottom:0,right:0,left:0,width:0,
height:0},n={boundingClientRect:k.getBoundingClientRect(),intersectionRatio:l,intersectionRect:m,isIntersecting:0<l,rootBounds:m,target:k,time:Ta()};N(function(){return a(n)})}for(var e=[],f=[],g=0;g<b.length;g++)e.push(0),f.push(-1);c.sort(function(k,l){return k-l});return function(){for(var k=0;k<b.length;k++){var l=Sn(b[k]);if(l>e[k])for(;f[k]<c.length-1&&l>=c[f[k]+1];)d(b[k],l),f[k]++;else if(l<e[k])for(;0<=f[k]&&l<=c[f[k]];)d(b[k],l),f[k]--;e[k]=l}}},Yn=function(a,b,c){for(var d=0;d<c.length;d++)1<
c[d]?c[d]=1:0>c[d]&&(c[d]=0);if(Vn){var e=!1;N(function(){e||Xn(a,b,c)()});return Wn(function(f){e=!0;for(var g={Za:0};g.Za<f.length;g={Za:g.Za},g.Za++)N(function(k){return function(){return a(f[k.Za])}}(g))},b,c)}return E.setInterval(Xn(a,b,c),1E3)},Zn=function(a){Vn?0<=a&&a<Un.length&&Un[a]&&(Un[a].disconnect(),Un[a]=void 0):E.clearInterval(a)};
var $n=function(a,b,c){function d(){var g=a();f+=e?(Ta()-e)*g.playbackRate/1E3:0;e=Ta()}var e=0,f=0;return{Yb:function(g,k,l){var m=a(),n=m.xe,r=void 0!==l?Math.round(l):void 0!==k?Math.round(m.xe*k):Math.round(m.yg),t=void 0!==k?Math.round(100*k):0>=n?0:Math.round(r/n*100),q=K.hidden?!1:.5<=Sn(c);d();var u=un(c,"gtm.video",[b]);u["gtm.videoProvider"]="youtube";u["gtm.videoStatus"]=g;u["gtm.videoUrl"]=m.url;u["gtm.videoTitle"]=m.title;u["gtm.videoDuration"]=Math.round(n);u["gtm.videoCurrentTime"]=
Math.round(r);u["gtm.videoElapsedTime"]=Math.round(f);u["gtm.videoPercent"]=t;u["gtm.videoVisible"]=q;jn(u)},Ah:function(){e=Ta()},Tc:function(){d()}}};var ao=E.clearTimeout,bo=E.setTimeout,S=function(a,b,c){if(Ji()){b&&N(b)}else return Re(a,b,c)},co=function(){return E.location.href},eo=function(a){return Sg(Ug(a),"fragment")},fo=function(a){return Tg(Ug(a))},T=function(a,b){return Dg(a,b||2)},go=function(a,b,c){var d;b?(a.eventCallback=b,c&&(a.eventTimeout=c),d=jn(a)):d=jn(a);return d},ho=function(a,b){E[a]=b},U=function(a,b,c){b&&(void 0===E[a]||c&&!E[a])&&(E[a]=
...
0<l.length&&(k=l[0])}else k=K.getElementById(b.vtp_elementId);if(k)switch(g){case "BOOLEAN":var m=(Number(b.vtp_onScreenRatio)||50)/100;e.value=Sn(k)>=m&&!Tn(k);break;case "PERCENT":e.value=0,Tn(k)||(e.value=Math.round(1E3*Sn(k))/10)}a[c]=e;return e.value})}();
Z.b.sdl=["google"],function(){function a(){return!!(Object.keys(l("horiz.pix")).length||Object.keys(l("horiz.pct")).length||Object.keys(l("vert.pix")).length||Object.keys(l("vert.pct")).length)}function b(x){for(var A=[],B=x.split(","),z=0;z<B.length;z++){var D=Number(B[z]);if(isNaN(D))return[];n.test(B[z])||A.push(D)}return A}function c(){var x=0,A=0;return function(){var B=Rn(),z=B.height;x=Math.max(w.scrollLeft+B.width,x);A=Math.max(w.scrollTop+z,A);return{Ag:x,Bg:A}}}function d(){q=U("self");
u=q.document;w=u.scrollingElement||u.body&&u.body.parentNode;y=c()}function e(x,A,B,z){var D=l(A),H={},M;for(M in D){H.Ja=M;if(D.hasOwnProperty(H.Ja)){var O=Number(H.Ja);x<O||(go({event:"gtm.scrollDepth","gtm.scrollThreshold":O,"gtm.scrollUnits":B.toLowerCase(),"gtm.scrollDirection":z,"gtm.triggers":D[H.Ja].join(",")}),xn("sdl",A,function(da){return function(ca){delete ca[da.Ja];return ca}}(H),{}))}H={Ja:H.Ja}}}function f(){var x=y(),A=x.Ag,B=x.Bg,z=A/w.scrollWidth*100,D=B/w.scrollHeight*100;e(A,
"horiz.pix",r.Pb,t.Pd);e(z,"horiz.pct",r.Ob,t.Pd);e(B,"vert.pix",r.Pb,t.ie);e(D,"vert.pct",r.Ob,t.ie);wn("sdl","pending",!1)}function g(){var x=250,A=!1;u.scrollingElement&&u.documentElement&&q.addEventListener&&(x=50,A=!0);var B=0,z=!1,D=function(){z?B=bo(D,x):(B=0,f(),ko("sdl")&&!a()&&(We(q,"scroll",H),We(q,"resize",H),wn("sdl","init",!1)));z=!1},H=function(){A&&y();B?z=!0:(B=bo(D,x),wn("sdl","pending",!0))};return H}function k(x,A,B){if(A){var z=b(String(x));xn("sdl",B,function(D){for(var H=0;H<
z.length;H++){var M=String(z[H]);D.hasOwnProperty(M)||(D[M]=[]);D[M].push(A)}return D},{})}}function l(x){return yn("sdl",x,{})}function m(x){N(x.vtp_gtmOnSuccess);var A=x.vtp_uniqueTriggerId,B=x.vtp_horizontalThresholdsPixels,z=x.vtp_horizontalThresholdsPercent,D=x.vtp_verticalThresholdUnits,H=x.vtp_verticalThresholdsPixels,M=x.vtp_verticalThresholdsPercent;switch(x.vtp_horizontalThresholdUnits){case r.Pb:k(B,A,"horiz.pix");break;case r.Ob:k(z,A,"horiz.pct")}switch(D){case r.Pb:k(H,A,"vert.pix");
break;case r.Ob:k(M,A,"vert.pct")}ko("sdl")?yn("sdl","pending")||(v||(d(),v=!0),N(function(){return f()})):(d(),v=!0,w&&(lo("sdl"),wn("sdl","pending",!0),N(function(){f();if(a()){var O=g();Ve(q,"scroll",O);Ve(q,"resize",O)}else wn("sdl","init",!1)})))}var n=/^\s*$/,r={Ob:"PERCENT",Pb:"PIXELS"},t={ie:"vertical",Pd:"horizontal"},q,u,w,v=!1,y;(function(x){Z.__sdl=x;Z.__sdl.g="sdl";Z.__sdl.h=!0;Z.__sdl.priorityOverride=0})(function(x){x.vtp_triggerStartOption?m(x):Pm(function(){m(x)})})}();
...
Z.b.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=un(c,"gtm.click");go(d)}}(function(b){Z.__cl=b;Z.__cl.g="cl";Z.__cl.h=!0;Z.__cl.priorityOverride=0})(function(b){if(!ko("cl")){var c=U("document");Ve(c,"click",a,!0);lo("cl")}N(b.vtp_gtmOnSuccess)})}();Z.b.k=["google"],function(){(function(a){Z.__k=a;Z.__k.g="k";Z.__k.h=!0;Z.__k.priorityOverride=0})(function(a){return io(a.vtp_name,T("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
function f(v){N(function(){function y(){for(var A=x.getElementsByTagName("iframe"),B=A.length,z=0;z<B;z++)e(A[z],v)}var x=U("document");y();Gn(y)})}function g(v,y){var x,A;function B(){W=$n(function(){return{url:Y,title:ba,xe:J,yg:v.getCurrentTime(),playbackRate:X}},y.Ad,v.getIframe());J=0;ba=Y="";X=1;return z}function z(sa){switch(sa){case q.PLAYING:J=Math.round(v.getDuration());Y=v.getVideoUrl();if(v.getVideoData){var P=v.getVideoData();ba=P?P.title:""}X=v.getPlaybackRate();y.qg?W.Yb("start"):W.Tc();
L=m(y.sh,y.rh,v.getDuration());return D(sa);default:return z}}function D(){xa=v.getCurrentTime();Ba=(new Date).getTime();W.Ah();Aa();return H}function H(sa){var P;switch(sa){case q.ENDED:return O(sa);case q.PAUSED:P="pause";case q.BUFFERING:var Q=v.getCurrentTime()-xa;P=1<Math.abs(((new Date).getTime()-Ba)/1E3*X-Q)?"seek":P||"buffering";v.getCurrentTime()&&(y.pg?W.Yb(P):W.Tc());ca();return M;case q.UNSTARTED:return B(sa);default:return H}}function M(sa){switch(sa){case q.ENDED:return O(sa);case q.PLAYING:return D(sa);
case q.UNSTARTED:return B(sa);default:return M}}function O(){for(;A;){var sa=x;ao(A);sa()}y.og&&W.Yb("complete",1);return B(q.UNSTARTED)}function da(){}function ca(){A&&(ao(A),A=0,x=da)}function Aa(){if(L.length&&0!==X){var sa=-1,P;do{P=L[0];if(P.Ga>v.getDuration())return;sa=(P.Ga-v.getCurrentTime())/X;if(0>sa&&(L.shift(),0===L.length))return}while(0>sa);x=function(){A=0;x=da;0<L.length&&L[0].Ga===P.Ga&&(L.shift(),W.Yb("progress",P.Ue,P.$e));Aa()};A=bo(x,1E3*sa)}}var W,L=[],J,Y,ba,X,xa,Ba,Oa=B(q.UNSTARTED);
A=0;x=da;return{onStateChange:function(sa){Oa=Oa(sa)},onPlaybackRateChange:function(sa){xa=v.getCurrentTime();Ba=(new Date).getTime();W.Tc();X=sa;ca();Aa()}}}function k(v){for(var y=v.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||100<z||0>z||A.push(z/100)}A.sort(function(D,H){return D-H});return A}function l(v){for(var y=v.split(","),x=y.length,A=[],B=0;B<x;B++){var z=parseInt(y[B],10);isNaN(z)||0>z||A.push(z)}A.sort(function(D,H){return D-H});return A}function m(v,y,x){var A=
...
z.length){var H={qg:y,og:x,pg:A,rh:B,sh:z,De:D,Ad:void 0===v.vtp_uniqueTriggerId?"":v.vtp_uniqueTriggerId},M=U("YT"),O=function(){f(H)};N(v.vtp_gtmOnSuccess);if(M)M.ready&&M.ready(O);else{var da=U("onYouTubeIframeAPIReady");ho("onYouTubeIframeAPIReady",function(){da&&da();O()});N(function(){for(var ca=U("document"),Aa=ca.getElementsByTagName("script"),W=Aa.length,L=0;L<W;L++){var J=Aa[L].getAttribute("src");if(b(J,"iframe_api")||b(J,"player_api"))return}for(var Y=ca.getElementsByTagName("iframe"),
ba=Y.length,X=0;X<ba;X++)if(!w&&d(Y[X],H.De)){S("https://www.youtube.com/iframe_api");w=!0;break}})}}else N(v.vtp_gtmOnSuccess)}var t=["www.youtube.com","www.youtube-nocookie.com"],q={UNSTARTED:-1,ENDED:0,PLAYING:1,PAUSED:2,BUFFERING:3,CUED:5},u,w=!1;Z.__ytl=n;Z.__ytl.g="ytl";Z.__ytl.h=!0;Z.__ytl.priorityOverride=0}();
...
Z.b.evl=["google"],function(){function a(){var f=Number(T("gtm.start"))||0;return(new Date).getTime()-f}function b(f,g,k,l){function m(){if(!Tn(f.target)){g.has(d.Qb)||g.set(d.Qb,""+a());g.has(d.Kc)||g.set(d.Kc,""+a());var r=0;g.has(d.Sb)&&(r=Number(g.get(d.Sb)));r+=100;g.set(d.Sb,""+r);if(r>=k){var t=un(f.target,"gtm.elementVisibility",[g.a]),q=Sn(f.target);t["gtm.visibleRatio"]=Math.round(1E3*q)/10;t["gtm.visibleTime"]=k;t["gtm.visibleFirstTime"]=Number(g.get(d.Kc));t["gtm.visibleLastTime"]=Number(g.get(d.Qb));
go(t);l()}}}if(!g.has(d.hb)&&(0==k&&m(),!g.has(d.Ka))){var n=U("self").setInterval(m,100);g.set(d.hb,n)}}function c(f){f.has(d.hb)&&(U("self").clearInterval(Number(f.get(d.hb))),f.i(d.hb))}var d={hb:"polling-id-",Kc:"first-on-screen-",Qb:"recent-on-screen-",Sb:"total-visible-time-",Ka:"has-fired-"},e=function(f,g){this.element=f;this.a=g};e.prototype.has=function(f){return!!this.element.getAttribute("data-gtm-vis-"+f+this.a)};e.prototype.get=function(f){return this.element.getAttribute("data-gtm-vis-"+
f+this.a)};e.prototype.set=function(f,g){this.element.setAttribute("data-gtm-vis-"+f+this.a,g)};e.prototype.i=function(f){this.element.removeAttribute("data-gtm-vis-"+f+this.a)};(function(f){Z.__evl=f;Z.__evl.g="evl";Z.__evl.h=!0;Z.__evl.priorityOverride=0})(function(f){function g(){var y=!1,x=null;if("CSS"===l){try{x=Af(m)}catch(H){}y=!!x&&w.length!=x.length}else if("ID"===l){var A=K.getElementById(m);A&&(x=[A],y=1!=w.length||w[0]!==A)}x||(x=[],y=0<w.length);if(y){for(var B=0;B<w.length;B++){var z=
new e(w[B],q);c(z)}w=[];for(var D=0;D<x.length;D++)w.push(x[D]);0<=v&&Zn(v);0<w.length&&(v=Yn(k,w,[t]))}}function k(y){var x=new e(y.target,q);y.intersectionRatio>=t?x.has(d.Ka)||b(y,x,r,"ONCE"===u?function(){for(var A=0;A<w.length;A++){var B=new e(w[A],q);B.set(d.Ka,"1");c(B)}Zn(v);if(n&&Fn)for(var z=0;z<Fn.length;z++)Fn[z]===g&&Fn.splice(z,1)}:function(){x.set(d.Ka,"1");c(x)}):(c(x),"MANY_PER_ELEMENT"===u&&x.has(d.Ka)&&(x.i(d.Ka),x.i(d.Sb)),x.i(d.Qb))}var l=f.vtp_selectorType,m;"ID"===l?m=String(f.vtp_elementId):
"CSS"===l&&(m=String(f.vtp_elementSelector));var n=!!f.vtp_useDomChangeListener,r=f.vtp_useOnScreenDuration&&Number(f.vtp_onScreenDuration)||0,t=(Number(f.vtp_onScreenRatio)||50)/100,q=f.vtp_uniqueTriggerId,u=f.vtp_firingFrequency,w=[],v=-1;g();n&&Gn(g);N(f.vtp_gtmOnSuccess)})}();
